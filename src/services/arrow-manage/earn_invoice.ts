...
export const useStartCalcMutation = () => {
  ...
  return useMutation(
    (data: StartCalcParam) => {
      return request('/api/earn_invoice/calc', { method: 'post', data: data });
    },
    {
...
export const useReCalcMutation = () => {
  ...
  return useMutation(
    (data: ReCalcParam) => {
      return request('/api/earn_invoice/calc', { method: 'patch', data: data });
    },
    {
...
export const useReCalcEachMutation = () => {
  ...
  return useMutation(
    (data: ReCalcEachParam) => {
      return request('/api/earn_invoice/each/calc', { method: 'patch', data: data });
    },
    {
      onSuccess(res, data: ReCalcParam) {
        client.invalidateQueries(eachEarnInvoiceQueryKey+data.earn_invoice_id);
...
export const useChangeStatusMutation = () => {
  ...
  return useMutation(
    (data: ChangeStatusParam) => {
      return request('/api/earn_invoice/each/status', { method: 'patch', data: data });
    },
    {
...
export const useChangeLockMutation = () => {
  ...
  return useMutation(
    (data: ChangeLockParam) => {
      return request('/api/earn_invoice/lock', { method: 'post', data: data });
    },
    {
