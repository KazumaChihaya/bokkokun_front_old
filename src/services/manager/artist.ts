...
export const useUpdateArtistMutation = () => {
  ...
  return useMutation(
    (data: EditArtistParam) => {
      return request('/api/manager/artist/' + data.id, {
        method: 'patch',
        data: data.data,
      });
    },
...
export const useResignActiveBoxMutation = () => {
  ...
  return useMutation(
    (data: ResignActiveBoxParam) => {
      return request('/api/manager/activebox/resign', {
        method: 'post',
        data: data,
      });
    },
...
export const useResignReserveBoxMutation = () => {
  ...
  return useMutation(
    (data: ResignReserveBoxParam) => {
      return request('/api/manager/reservebox/resign', {
        method: 'post',
        data: data,
      });
    },
...
export const useReserveToActiveBoxMutation = () => {
  ...
  return useMutation(
    (data: ResignReserveBoxParam) => {
      return request('/api/manager/reservebox/toactive', {
        method: 'post',
        data: data,
      });
    },
...
export const useEditReserveBoxMutation = () => {
  ...
  return useMutation(
    (data: EditReserveBoxParam) => {
      return request('/api/manager/reservebox', {
        method: 'patch',
        data: data,
      });
    },
...
export const useDeleteActiveBoxMutation = () => {
  ...
  return useMutation(
    (data: DeleteActiveBoxParam) => {
      return request('/api/manager/activebox', {
        method: 'delete',
        data: { id: data.active_box_id },
      });
    },
    {
